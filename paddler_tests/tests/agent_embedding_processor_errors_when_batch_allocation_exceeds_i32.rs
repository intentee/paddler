...
#[test]
fn agent_embedding_processor_errors_when_batch_allocation_exceeds_i32() -> Result<()> {
    let harness =
        EmbeddingProcessorHarness::build_with_inference_parameters(InferenceParameters {
