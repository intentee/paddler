...
#[test]
fn continuous_batch_scheduler_rejects_multimodal_request_when_all_sequence_slots_are_busy()
-> Result<()> {
    ...
    command_tx
        .send(ContinuousBatchSchedulerCommand::ContinueFromRawPrompt(
            ContinueFromRawPromptRequest {
                generate_tokens_stop_rx: occupying_stop_rx,
                generated_tokens_tx: occupying_tokens_tx,
        ...
        .send(
            ContinuousBatchSchedulerCommand::ContinueFromConversationHistory(
                ContinueFromConversationHistoryRequest {
                    generate_tokens_stop_rx: rejected_stop_rx,
                    generated_tokens_tx: rejected_tokens_tx,
