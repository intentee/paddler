...
use paddler_tests::start_in_process_cluster_with_qwen3_6_and_mmproj::start_in_process_cluster_with_qwen3_6_and_mmproj;
...
async fn qwen36_internal_endpoint_emits_reasoning_tokens_for_image_request() -> Result<()> {
    let cluster = start_in_process_cluster_with_qwen3_6_and_mmproj(1).await?;
