...
- coding, maintaining the HTTP client, that connects to the core library
- [we created an integration test harness for Paddler and were able to consolidate all the existing tests to use the new, improved harness almost automatically](https://github.com/intentee/paddler/pull/220)
