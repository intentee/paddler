...
use paddler_cli_tests::start_in_process_cluster_with_smolvlm2_and_n_batch::start_in_process_cluster_with_smolvlm2_and_n_batch;
...
async fn drive_oversized_image_fixture(
...
async fn agent_does_not_crash_on_oversized_image() -> Result<()> {
    ...
    drive_oversized_image_fixture(&inference_client, "sarnow.jpeg", "image/jpeg").await?;
    drive_oversized_image_fixture(&inference_client, "llamas.webp", "image/webp").await?;
