...
use paddler_cli_tests::ministral_3_in_process_cluster_params::Ministral3InProcessClusterParams;
use paddler_cli_tests::start_in_process_cluster_with_ministral_3::start_in_process_cluster_with_ministral_3;
...
async fn mistral3_internal_endpoint_emits_tool_call_parsed_event() -> Result<()> {
    let cluster = start_in_process_cluster_with_ministral_3(Ministral3InProcessClusterParams {
        deterministic_sampling: true,
        ..Ministral3InProcessClusterParams::default()
    })
    .await?;
