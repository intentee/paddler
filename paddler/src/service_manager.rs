...
mod tests {
    ...
    struct StoppingService {
        stop_notify: Arc<Notify>,
    }

    #[async_trait(?Send)]
    impl Service for StoppingService {
        fn name(&self) -> &'static str {
            "test::stopping_service"
        }
    ...
    #[actix_web::test]
    async fn service_ok_cascades_shutdown_to_others() -> Result<()> {
        ...
        service_manager.add_service(StoppingService {
